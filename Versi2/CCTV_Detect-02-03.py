        ...
        for vehicle in vehicle_results:
            for box in vehicle.boxes:
                ...
                if class_id in [2, 3, 5, 7] and confidence > 0.80:  # ID COCO untuk kendaraan
                    ...
                    # Jalankan deteksi plat nomor pada crop kendaraan
                    ...
                    for result in license_plate_results:
                        for lp_box in result.boxes:
                            ...
                            if lp_conf > 0.5:
                                # Konversi koordinat plat nomor dari crop ke koordinat asli
                                abs_lx1 = lx1 + x1
                                abs_ly1 = ly1 + y1
                                abs_lx2 = lx2 + x2
                                abs_ly2 = ly2 + y2

                                # Tampilkan bounding box plat nomor
                                frame = f_image_box_license(frame, abs_lx1, abs_lx2, abs_ly1, abs_ly2, lp_conf)
