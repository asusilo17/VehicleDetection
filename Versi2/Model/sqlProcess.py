...
def f_sql_savePlateIdentification (p_file_name, p_license_number, p_predict_pct=0, p_label="", p_confidence=0, p_latitude=0, p_longitude=0, p_remark="", p_metode=""):
    ...
    sql = f"""insert into TransVehiceLicense (tvl_file_name, tvl_license_number, tvl_predict_pct, tvl_label, tvl_confidence, tvl_latitude, tvl_longitude, tvl_remark, metode) values
                ('{p_file_name}', '{p_license_number}', {p_predict_pct}, '{p_label}', {p_confidence}, {p_latitude}, {p_longitude}, '{p_remark}', '{p_metode}')
                """
